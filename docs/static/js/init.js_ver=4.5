...
/***************** Home Slider ******************/
	...
	function customSliderHeight(){
		...
		if($('#header-outer[data-transparent-header="true"]')) $('.orbit-wrapper').addClass('transparent-header');
	}
...
/*-------------------------------------------------------------------------*/	
	...
	$('body').on('click','.facebook-share', facebookShare);
	$('body').on('click','.google-plus-share', googlePlusShare);
	$('body').on('click','.nectar-social:not(".woo") .twitter-share', twitterShare);
	$('body').on('click','.nectar-social.woo .twitter-share', wooTwitterShare);
	$('body').on('click','.nectar-social:not(".woo") .linkedin-share', linkedInShare);
	$('body').on('click','.nectar-social.woo .linkedin-share', woolinkedInShare);
	$('body').on('click','.nectar-social:not(".woo") .pinterest-share', pinterestShare);
...
$('body').on('click','#to-top',function(){
	...
	function updatePrettyPhotoGallery(){
		$('.portfolio-items').each(function(){
			...
			var $unique_id = Math.floor(Math.random()*10000);
			$('.col.isotope-item:not(.isotope-hidden) .vert-center a[rel^="prettyPhoto"]').attr('rel','prettyPhoto['+$unique_id+'_sorted]');
		});
	}
